...
public class Simulador
{
    ...
    private ArrayList<Onibus> onibos;
    ...
    public void adicionarOnibus(String modelo, String marca, String placa, int capacidadeDeCarga) {
        Onibus onibus = new Onibus(modelo, marca, placa, capacidadeDeCarga);
        onibos.add(onibus);
    }
    ...
    private Onibus buscarOnibus(String modelo) {
        for (Onibus onibus : onibos) {
            if (onibus.obterModelo().equals(modelo)) {
                return onibus;
            }
        }
        return null;
    ...
    public void mudarVelocidadeOnibus(String modelo, int novaVelocidade) {
        Onibus onibus = buscarOnibus(modelo);
        if (onibus != null) {
            onibus.definirVelocidadeAtual(novaVelocidade);
            System.out.println("Velocidade do carro " + modelo + " alterada!");
        }
        else {
            System.out.println("Onibus " + modelo + " não encontrado!");
        }
    }
